...
class CSVReader {
public:
    //Se agrego el parametro de la función Graph& graphRef al final
    static void loadStudents(std::string fileName, HashTable& hashRef, AVLTree& avlRef, Graph& grafo) {
        ...
        while (std::getline(file, line)) {
            ...
            // Insertar en todas las estructuras simultáneamente
            hashRef.insert(s);
            avlRef.insert(s);

            //Se registra estudinate como vértice del grafo
            grafo.addStudentVertex(s.student_id);
